...
task_total = 0 # число заданий
hour = 0 # рабочий час
phone_answer_des = 0 # Решение на звонок жены
while hour != 8:
  hour += 1
  print(hour, 'час')
  task_num = int(input('Сколько задач решит Максим? ')) # число заданий в час
  task_total += task_num
  phone_answer = int(input('Звонит жена. Взять трубку? (1-да, 0-нет) '))
  phone_answer_des += phone_answer
print('Рабочий день закончился. Всего выполнено задач:', task_total)
if phone_answer_des > 0:
