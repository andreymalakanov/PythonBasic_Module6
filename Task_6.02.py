...
name = input('Введеите имя должника: ')
debt = int(input('Введите сумму долга: '))
amortization = 0
print('Привет,', name + '!')
while amortization < debt: 
  print('Ваша задолжность составляет', debt, 'рублей.')
  amortization = int(input('Сколько рублей вы внесёте прямо сейчас, чтобы её погасить? '))
  if amortization < debt:
